...
Wl0 f7 inParamDecl '<String filePath,Recordset recordset> param;' #txt
Wl0 f7 inParamInfo 'filePath.description=File path of the Excel sheet to be written.
recordset.description=Recordset represents the content of the Excel sheet to be written.' #txt
Wl0 f7 inParamTable 'out.filePath=param.filePath;
out.recordset=param.recordset;
' #txt
Wl0 f7 outParamDecl '<> result;' #txt
Wl0 f7 callSignature call(String,Recordset) #txt
Wl0 f7 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>call(String,Recordset)</name>
    </language>
</elementInfo>
' #txt
